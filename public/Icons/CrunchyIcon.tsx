...
export const CrunchyIcon = () => {
  ...
  return (
    <Box onClick={() => push('/home')} sx={{cursor:'pointer',display:'flex',justifyContent:'center',alignItems:'center',color:'#f47521'}}>
    ...
    <Typography variant='h2' sx={{fontSize:'18px',fontWeight:'600',ml:'5px',letterSpacing:'.5px'}}>crunchyroll</Typography>
  </Box>
  )
}
