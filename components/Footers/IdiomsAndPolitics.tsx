...
export const IdiomsAndPolitics = () => {
  return (
    <footer style={{width:'100vw',display:'flex',flexDirection:'column',bottom:'20px',position:'relative'}}>
        <Box className="footer-idioms-politics" style={{marginBottom:'20px',display:'flex', justifyContent:'center', alignItems:'center'}}>
        ...
        <Box className="footer-idioms-politics"  style={{position:'relative',display:'flex',justifyContent:'space-around', alignItems:'center'}}>
